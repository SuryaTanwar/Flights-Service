...
app.listen(ServerConfig.PORT, async () => {
    ...
    // below are the example of function which are given by sequelize when association is setup between atleast two models
    // this is also known as magic method in sequelize
    // we can check all the magic method provided by sequelize to the mode by the following command
